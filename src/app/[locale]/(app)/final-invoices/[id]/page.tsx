    ...
    <div className="mx-auto max-w-5xl px-6 py-8">
      ...
      {isDraft && (
        <div className="mt-4 rounded-md border border-amber-300 bg-amber-50 p-3 text-sm text-amber-900">
          <strong>Koncept</strong> — faktura zatím nemá přidělené číslo. Klikněte
          níže na <em>&ldquo;{t("FinalInvoices.actions.markSent")}&rdquo;</em>, aby se přidělilo
          číslo (např. <code>FA2605070001</code>) a PDF se uložilo s tímto názvem.
        </div>
      )}
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        {!isDraft && (
          <a
            href={`/final-invoices/${id}/pdf?live=1`}
            target="_blank"
            rel="noreferrer"
            title={
              locale === "cs"
        ...
        <a href={`/final-invoices/${id}/pdf?download=1&live=1`} download>
          <Button variant="outline" size="sm">
            Download PDF ↓
          </Button>
        </a>
