      ...
      <div className="mb-6 flex flex-wrap gap-2 text-sm">
        {(["ALL", ...allowed] as const).map((s) => {
          ...
          return (
            <Link
              key={s}
              href={s === "ALL" ? "/advance-invoices" : `/advance-invoices?status=${s}`}
              className={
                active
            ...
            >
              {s === "ALL" ? t("Common.all") : t(`AdvanceInvoices.status.${s}`)}
            </Link>
          );
        })}
      </div>
            ...
            <thead className="border-b border-border bg-secondary/40 text-xs uppercase tracking-wider text-muted-foreground">
              <tr>
                <th className="px-4 py-2 text-left">
                  <SortHeader label={t("AdvanceInvoices.fields.number")} field="number" />
                </th>
                ...
                <th className="px-4 py-2 text-left">
                  <SortHeader label={t("AdvanceInvoices.fields.dueDate")} field="dueDate" />
                </th>
